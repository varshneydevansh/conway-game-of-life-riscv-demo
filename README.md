...
Readable log output:
```bash
python3 conway.py glider 10 0 --no-clear
```
...
This project implements Conway's Game of Life as a Python script with simple terminal graphics.

It demonstrates:

- iteration over a 2D grid
- local neighbor inspection
- current-state to next-state updates
- double buffering through `current_grid` and `next_grid`
- simple terminal rendering using `.` and `#`
- optional debugging output for inspecting one cell's transition

I built it in small commits so the repository history shows the learning path from a static grid to a complete scripted demo.


## EXAMPLE OUTPUT OF THE SCRIPT 

```bash
Generation: 39 | Size: 20x20 | Live cells: 5 | Touching edge: no
....................
....................
....................
....................
...
Usage: python3 conway.py [pattern] [generations] [delay] [--no-clear] [--explain row col]
Patterns: blinker, glider, block, lonely
Example: python3 conway.py glider 40 0.5 --no-clear --explain 2 2
Use --no-clear for readable logs and --explain row col to inspect one cell.
